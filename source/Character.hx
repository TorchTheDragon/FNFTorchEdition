...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		{
			case 'torch':
				//Torch the Dragon - New
				tex = Paths.getSparrowAtlas('dragons-stuff/peeps/bestdwagonboio');
				frames = tex;
				...
				addOffset("singRIGHT", -12, 56);
				addOffset("singLEFT", 16, 52);
				addOffset("singDOWN", 17, 53);
				addOffset("singUPmiss", 10, 87);
				addOffset("singRIGHTmiss", -12, 56);
				addOffset("singLEFTmiss", 16, 52);
				addOffset("singDOWNmiss", 17, 53);
				addOffset("hey", -4, 52);
				addOffset('firstDeath', -10, 48);
				addOffset('deathLoop', -8, 62);
				addOffset('deathConfirm', -4, 53);
				addOffset('scared', -7, 65);
